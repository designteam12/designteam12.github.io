...
$(document).ready(function() {
    ...
    $('.detailSearchBtn').click(function(e) {
        e.preventDefault();
        var displayStatus = $(".detailSearch").css("display");
    ...
    /*$('.detailShTab .toggleBtn').click(function(e) {
        e.preventDefault();
        var selColName = DetailSearchTop.selColl;
        var selCateName = DetailSearchTop.selCate;
        console.log("selColName = " + selColName);
        console.log("selCateName = " + selCateName);
    ...
    $('.detailShTab .inner a').click(function(e) {
        e.preventDefault();
    ...
    $('.divPopup .popCont').on('scroll', function() {
        if ($(this).hasScrollBar()) {
            var divPopupId = $(this).parents('.divPopup').attr("id")
            /*if (divPopupId != "newCabinet_div") {*/
    ...
    let wm1 = $('#wm1').length > 0 ? $('#wm1').offset().top - 63 : 0; 
    let wm2 = $('#wm2').length > 0 ? $('#wm2').offset().top - 63 : 0; 
    let wm3 = $('#wm3').length > 0 ? $('#wm3').offset().top - 63 : 0; 
    let wm4 = $('#wm4').length > 0 ? $('#wm4').offset().top - 63 : 0;
    let wm5 = $('#wm5').length > 0 ? $('#wm5').offset().top - 63 : 0; 
    let wm6 = $('#wm6').length > 0 ? $('#wm6').offset().top - 63 : 0; 
    let wm7 = $('#wm7').length > 0 ? $('#wm7').offset().top - 63 : 0; 
    let wm8 = $('#wm8').length > 0 ? $('#wm8').offset().top - 63 : 0; 
    let wm9 = $('#wm9').length > 0 ? $('#wm9').offset().top - 63 : 0; 
    let wm10 = $('#wm10').length > 0 ? $('#wm10').offset().top - 63 : 0; 
    let wm11 = $('#wm11').length > 0 ? $('#wm11').offset().top - 63 : 0; 
    let wm12 = $('#wm12').length > 0 ? $('#wm12').offset().top - 63 : 0; 
    let wm13 = $('#wm13').length > 0 ? $('#wm13').offset().top - 63 : 0; 
    let wm14 = $('#wm14').length > 0 ? $('#wm14').offset().top - 63 : 0; 
    ...
    $('.privacyBtn').click(function(e){
        e.preventDefault();
        let ph = $('.privacyPop .popHeader').outerHeight(true);
        $('.privacyPop .popCont').css({'height':'calc(100% - ' +ph+'px)'})
        $('.blackBg1').show();
        $('.privacyPop').addClass('on');
    });
    $('.privacyPopClose').click(function(e){
        e.preventDefault();
        $('.blackBg1').hide();
    ...
    //검은색 배경을 선택했을 경우 팝업창이 닫힐 수 있도록
    var blackBg = document.querySelector('.blackBg1');
    $('.blackBg1').click(function(e){
		blackBg.style.display = 'none';
		$('.divPopup').removeClass("on");
	});
});    